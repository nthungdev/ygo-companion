...
const PolicyPage = () => {
  return (
    <div className="tac" class="p-8">
      <p>TERMS OF USE</p>

      <br />
      <p>Last updated May 26, 2020 </p>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and YGO
        Companion ("Company", “we”, “us”, or “our”), concerning your access to
        and use of the YGO Companion app as well as any other media form, media
      ...
      <br />
      <p>
        1. Make any unauthorized use of the Site, including collecting usernames
      ...
      <p>2. Use the Site to advertise or offer to sell goods and services. </p>
      ...
      <p>
        12. Use the Site as part of any effort to compete with us or otherwise
      ...
      <p>
        14. Attempt to bypass any measures of the Site designed to prevent or
      ...
      <p>
        18. Upload or transmit (or attempt to upload or to transmit) viruses,
      ...
      <p>
        ...
        Clinton County County, New York, and the Parties hereby consent to, and
      ...
      <p>
        In order to resolve a complaint regarding the App or to receive further
        information regarding use of the App, please contact us at:
      </p>

      <p>Hung Nguyen</p>

      <p>60 Olivetti Pl. Apt. 2</p>

      <p>Plattsburgh, NY 12901</p>

      <p>United States</p>

      <p>Phone: 5186453969</p>

      <p>nthungdev.vn@gmail.com</p>
    </div>
  )
}
